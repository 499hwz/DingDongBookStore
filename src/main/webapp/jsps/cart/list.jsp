    ...
    <script type="text/javascript">
            ...
            $(".jian").click(function () {
                ...
                if (quantity == 1) {
                    if (confirm("您是否真要删除该条目？")) {
                        location = "/yosebook-ssm/cartItem/batchDelete.do?cartItemIds=" + id;
                    }
                } else {
        ...
        function sendUpdateQuantity(id, quantity) {
            $.ajax({
                async: false,
                cache: false,
                url: "/yosebook-ssm/cartItem/updateQuantity.do",
            ...
            <c:forEach items="${cartItemList }" var="cartItem">
                <tr align="center">
                    ...
                    <td align="left" width="400px"><a
                            href="<c:url value='/book/load.do?bid=${cartItem.book.bid }'/>"><span>${cartItem.book.bname }</span></a>
                    </td>
                    <td>
