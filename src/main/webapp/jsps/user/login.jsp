...
<html>
 ...
 <body>
	...
	<section>
	  <div id="content">
	  	<form target="_top" action="<c:url value='/user/login.do'/>" method="post" id="loginForm">
			<table style="padding-left: 30px;padding-top: 20px;width: 100%;height: 100%">
				<tr>
					<td rowspan="10">
						<%--<img src="<c:url value='/images/yose_show.jpg'/>">--%>
						<img width="350px"  src="<c:url value='/images/bookpic.png'/>">
					</td>
				</tr>
				<tr>
					<td>
	...
	<footer>
		<p>Copyright &copy; 叮咚网 2013-2016, All Rights Reserved&nbsp;&nbsp;|&nbsp;&nbsp;京ICP证041189号音像制品经营许可证 京音网8号</p>
